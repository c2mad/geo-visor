  ...
  return (
    <>
      <div className="bg-inherit">
              ...
              <div className="flex h-full items-center justify-center ">
                ...
                >
                  ...
                  <button data-element="submit" className="formkit-submit">
                    ...
                    <span className="cursor-pointer rounded-lg bg-rose-600 px-5 py-3 text-center text-sm font-medium text-white hover:bg-rose-800 focus:bg-rose-300 focus:ring-4 dark:bg-rose-600 dark:hover:bg-rose-700 dark:focus:bg-rose-800">
                      Buscar
                    </span>
                  </button>
                </div>
        ...
        <div className="mx-auto w-full max-w-[1100px] px-3 pb-20">
          <h3 className="mb-20 text-center text-4xl font-semibold text-black">
