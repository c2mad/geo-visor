  ...
  return (
    <>
      <div className="mx-auto w-full max-w-[1100px] px-3 dark:text-white">
        ...
        <div className="p-4">
          <a
            href="../utils/MANUAL DE USUARIO PARA EL GEOVISOR.pdf"
            download="MANUAL DE USUARIO PARA EL GEOVISOR.pdf"
          ...
          <a
            href="../utils/MANUAL DE USUARIO PARA EL GEOVISOR.pdf"
            download="MANUAL DE USUARIO PARA EL GEOVISOR.pdf"
            className=" dark:hover:text-dark z-10 my-3 flex flex-shrink-0 items-center justify-center rounded-lg border border-gray-300 bg-amber-400 p-4 text-center text-lg font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-red dark:hover:bg-gray-100 dark:focus:ring-gray-700"
            type="button"
          >
            Manual de usuario para descargas de archivos{" "}
            <svg
              className="ml-2.5 h-4 w-4"
              xmlns="http://www.w3.org/2000/svg"
              height="1em"
